  ...
  return <div className={iconStyle.connectwithus}>{children}
    <div className={iconStyle.connecticons}>
      ...
      <div className={iconStyle.eachicon}>
        <a className={iconStyle.images} href="https://twitter.com/CUSD"> <img src={tweet} width="65px" height="65px" /></a>
        <a className={iconStyle.images} href="https://www.facebook.com/CUSustainableDesign/?fref=ts"><img src={face} width="65px" height="65px" /></a>
        <a className={iconStyle.images} href="https://www.linkedin.com/company/cornellusd"><img src={linked} width="65px" height="65px" /></a>
        <a className={iconStyle.images} href="https://www.instagram.com/cusustainabledesign/?hl=en"><img src={insta} width="70px" height="70px" /></a>
      </div>
    </div>
